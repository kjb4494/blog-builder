...
scoring 매개 변수는 보고 할 모델 품질의 척도를 선택합니다.이 경우에는 음의 평균 오차(negative mean absolute error, MAE)를 선택했습니다. scikit-learn에 대한 문서는 [*옵션 목록*](https://scikit-learn.org/stable/modules/model_evaluation.html)을 보여줍니다.
