...
![사진](/assets/imgs/posts/ml/pandas-001.png)
...
![사진](/assets/imgs/posts/ml/pandas-002.png)
...
![사진](/assets/imgs/posts/ml/pandas-003.png)
...
![사진](/assets/imgs/posts/ml/pandas-004.png)
...
다중 인덱스의 사용 사례는 [*Pandas 문서의 MultiIndex/Advanced Selection 섹션*](https://pandas.pydata.org/pandas-docs/stable/user_guide/advanced.html)에서 사용 지침과 함께 자세히 설명되어 있습니다.
...
![사진](/assets/imgs/posts/ml/pandas-005.png)
...
![사진](/assets/imgs/posts/ml/pandas-006.png)
...
![사진](/assets/imgs/posts/ml/pandas-007.png)
...
이는 서로 다른 DataFrame이나 Series 개체에 데이터가 있지만 동일한 필드(열)가 있는 경우에 유용합니다. 한 가지 예시로, [*원산지(이 예에서는 캐나다 및 영국)를 기준으로 데이터를 분할하는 YouTube 동영상 dataset*](https://www.kaggle.com/datasnaek/youtube-new)입니다. concat()을 사용하여 두 국가를 하나로 묶을 수 있습니다.
```python
